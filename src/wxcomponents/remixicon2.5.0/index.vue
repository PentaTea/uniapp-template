<template>
<uni-shadow-root class="remixicon2.5.0-index"><view :class="(classPrefix)+' '+(name)" :style="size?'font-size:'+size+'px;':'' + rpxSize?'font-size:'+rpxSize+'rpx;':'' + color?'color:'+color+';':''"></view></uni-shadow-root>
</template>
...
global['__wxRoute'] = 'remixicon2.5.0/index'
Component({
  options: {
    addGlobalClass: true,
  },
...
export default global['__wxComponents']['remixicon2.5.0/index']
</script>
...
@font-face {
  ...
  src: url('https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.eot#iefix') format('embedded-opentype'),
    /* IE6-IE8 */
    url("https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.woff2") format("woff2"),
