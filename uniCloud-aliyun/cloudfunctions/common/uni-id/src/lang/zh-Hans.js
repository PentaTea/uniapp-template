...
const sentence = {
  ...
  'context-param-required':
    "context内缺少{param}，请使用uniID.createInstance传入客户端信息，例：uniID.createInstance({context:{PLATFORM:'h5'}})",
  ...
  'config-file-invalid':
    '请确保公用模块uni-id对应的配置文件（common/uni-config-center/uni-id/config.json）格式正确（不可包含注释）',
  'config-file-not-found':
    '请在common/uni-config-center/uni-id/config.json内添加uni-id相关配置信息',
