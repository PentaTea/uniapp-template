...
async function callQQOpenApi({ name, url, data, options, defaultOptions }) {
  options = Object.assign({}, defaultOptions, options, {
    data: camel2snakeJson(Object.assign({}, data)),
  })
  let result
  try {
  ...
  if (
    ...
    (contentType.indexOf('text/plain') === 0 || contentType.indexOf('application/json') === 0)
  ) {
    try {
